...
const translations: any = {
  ...
  hin: {
    ...
    title: "हमारी कहानी",
    p1: "Nivesh एक award-winning डिजिट���-फर्स्ट प्लेटफार्म है जो स्वतंत्र म्यूचुअल फंड डिस्ट्रीब्य��टर्स को उनके AUM बढ़ाने मे��� सहायता करता है।",
    ...
    investorsFooter:
      "और अन्य प्रमुख एंजेल निवेशक जो ��फल उद्यमी, वेंचर कैपिटलिस��ट और फंड मैनेजर हैं",
