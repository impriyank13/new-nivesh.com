...
const translations: any = {
  ...
  hin: {
    ...
    approachText: "हमारा ऐप निव��शों को ट्रैक करने को सरल बनाता है।",
    ...
    investorsSubtitle:
      "हमारे महत्वाकांक्षी निवेशक जिन्होंने हमारे विज़न में विश्वास रखा ह��।",
    investorsFooter:
  ...
  mar: {
    ...
    commitmentText:
      "आम्ही सुरक्षित, अनुपालन-अनुकूल आणि मानव-केंद्रित फिनटेक प्रदान करण्यात बांधील आहोत जे सल्लागारा���ना सशक्त करते आणि गुंतवणूकदारांचे संरक्षण करते.",
    teamTitle: "आमची टीम",
    teamText:
    ...
    partnersSubtitle:
      "आम्ही आमच्या पोहोच वाढविण्यासाठी आघाडीच्या आर्थिक संस���थांशी आणि भागीदारांशी सहकार्य करतो.",
  },
};
